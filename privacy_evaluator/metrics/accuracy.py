...
def accuracy_ratio(train_accuracy, test_accuracy):
    """Calculate the ratio between the train and test accuracy.

    The ratio is calculated by dividing the test accuracy from thee train accuracy. The result is higher than 1 if the
    train accuracy is higher than the test accuracy and smaller than 1 if the train accuracy is smaller than the test
    accuracy.
